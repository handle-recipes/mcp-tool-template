...
export const createRecipeTools = (api: FirebaseFunctionsAPI) => [
  ...
  createMCPTool({
    ...
    schema: z.object({
        ...
        .array(
          z.object({
            ...
            unit: z
              ...
              .describe(
                'Unit of measurement (e.g., "g", "ml", "cup", "free_text")'
              ),
            quantityText: z
              .string()
              .optional()
      ...
      sourceUrl: z.string().optional().describe("URL source of the recipe"),
    }),
    handler: async ({
      name,
      description,
  ...
  createMCPTool({
    ...
    schema: z.object({
      ...
      offset: z.number().optional().describe("Number of suggestions to skip"),
      status: z
        .enum([
          "submitted",
          "under-review",
